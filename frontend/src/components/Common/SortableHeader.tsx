        ...
        {sortKey && onSort ? (
          <button
            ...
            className={`group inline-flex items-center gap-1.5 transition cursor-pointer ${
              isSorted
                ? "text-blue-600 dark:text-blue-400 font-bold hover:text-blue-700 dark:hover:text-blue-300"
          ...
          >
            ...
            <span
              className={`rounded-md p-0.5 transition ${
                isSorted
                  ? "bg-blue-100 text-blue-700 group-hover:bg-blue-200 dark:bg-blue-900/60 dark:text-blue-300 dark:group-hover:bg-blue-800/80"
          ...
          <button
            ...
            className={`rounded-md p-1 transition cursor-pointer ${
              isFiltered
                ...
                : "text-slate-400 hover:bg-slate-200/60 hover:text-slate-700 dark:text-slate-500 dark:hover:bg-slate-700 dark:hover:text-white"
            }`}
