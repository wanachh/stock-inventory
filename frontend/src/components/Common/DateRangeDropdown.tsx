              ...
              return (
                <button
                  ...
                  className={`rounded-xl px-2.5 py-1.5 text-left text-xs font-medium transition cursor-pointer ${
                    active
                      ? "bg-blue-50 font-bold text-blue-700 hover:bg-blue-100 dark:bg-blue-950/60 dark:text-blue-300 dark:hover:bg-blue-900/60"
          ...
          <div className="border-t border-slate-100 pt-2.5 dark:border-slate-800">
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-slate-50/70 px-2.5 py-1.5 text-xs text-slate-800 hover:border-slate-300 focus:border-blue-500 focus:bg-white focus:outline-hidden dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:[color-scheme:dark] dark:hover:border-slate-600 dark:focus:border-blue-500 dark:focus:bg-slate-800 cursor-pointer"
                />
              </div>
              <div>
                <label className="block text-[10px] text-slate-400 mb-0.5">
            ...
            <div className="flex items-center justify-between">
              <button
                type="button"
                onClick={handleClear}
                className="text-xs font-medium text-slate-400 hover:text-rose-600 dark:text-slate-400 dark:hover:text-rose-400 cursor-pointer"
              >
                {t("tableFilter.clear")}
              </button>
              <button
                ...
                className="rounded-xl bg-blue-600 px-3 py-1.5 text-xs font-semibold text-white shadow-xs hover:bg-blue-700 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer dark:bg-blue-600 dark:hover:bg-blue-500"
              >
                {t("tableFilter.apply")}
              </button>
            </div>
