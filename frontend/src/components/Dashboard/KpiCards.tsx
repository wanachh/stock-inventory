  ...
  return (
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800/80 dark:bg-slate-900">
        ...
        <div className="mt-6 border-t border-slate-100 pt-4 dark:border-slate-800">
          <div className="flex items-center justify-between text-xs">
            <span className="text-slate-500 dark:text-slate-400">{t("dashboard.cogs")}</span>
      ...
      <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800/80 dark:bg-slate-900">
        ...
        <div className="mt-6 border-t border-slate-100 pt-4 dark:border-slate-800">
          <div className="flex items-center justify-between text-xs">
            <span className="text-slate-500 dark:text-slate-400">{t("dashboard.inValue")}</span>
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[11px] font-bold ${
              ...
              {isLowStock ? t("dashboard.needsRestock") : t("dashboard.normalStock")}
            </span>
          </div>
          ...
          <div className="mt-5">
            ...
            <div className="mt-1 flex items-baseline gap-2">
              ...
              <span className="text-sm font-bold text-slate-400">{t("common.items")}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 border-t border-slate-100 pt-4 dark:border-slate-800">
          {isLowStock ? (
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
              <span>{t("dashboard.allProductStatus")}</span>
